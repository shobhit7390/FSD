...
public class Course {
	...
	public Course(Integer courseId, String courseName, String description, String category, BigDecimal price, Float rating,
			String instructorName, String duration, String coursePic,String videoUrl,  String couponCode, BigDecimal discountPercentage,
	...
	public String toString() {
		return "Course [courseId=" + courseId + ", courseName=" + courseName + ", description=" + description
				...
				+ instructorName + ", duration=" + duration + ", coursePic=" + coursePic + ", couponCode=" + couponCode
