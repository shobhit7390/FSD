...
document.addEventListener('DOMContentLoaded', function() {
        ...
        if (userJson) {
          ...
          document.getElementById('userName').textContent = user.firstName+" "+user.lastName || 'User\'s Name';
          ...
          document.querySelector('.profile-card').innerHTML = '<p>Please log in to view your profile.</p>';
        }
      });
